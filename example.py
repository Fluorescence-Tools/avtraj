...
av_traj_1 = av.AVTrajectory(traj, '18D', attachment_atom_selection='resSeq 7 and name CB', strip_mask='resSeq 7')
av_traj_1 = av.AVTrajectory(traj_fn, '18D', attachment_atom_selection='resSeq 7 and name CB', strip_mask='resSeq 7')
...
# Pass a trajectory to fps.AVTrajectory. This creates an object, which can be
# accessed as a list. The objects within the "list" are accessible volumes
av_traj_2 = av.AVTrajectory(traj, '18D', attachment_atom_selection='resSeq 550 and name CB', strip_mask='resSeq 550')
# These accessible volumes can be saved as xyz-file
av1 = av_traj_2[0]
x, y = av1.pRDA(av0)
p.plot(x, y)
...
av_traj = av.AVTrajectory(traj, '18D', attachment_atom_selection='resSeq 7 and name CB', linker_length=25., linker_width=1.5, radius_1=6.0)
...
av_traj = av.AVTrajectory(traj, '18D', attachment_atom_selection='resSeq 7 and name CB', dye_parameter_set='D3Alexa488')
...
av_dist = av.AvDistanceTrajectory(traj, './examples/hGBP1_distance.json')
